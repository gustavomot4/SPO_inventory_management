...
import { Layers, ArrowLeft, PackagePlus, PackageMinus, AlertTriangle } from 'lucide-react'
    ...
    <div className="px-4 py-8 sm:px-6 lg:px-8 max-w-2xl mx-auto">
      <div className="flex flex-col items-center py-14 text-center">
        ...
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gray-100 mb-5">
          <Layers className="h-7 w-7 text-gray-500" aria-hidden="true" strokeWidth={1.5} />
        </div>
        ...
        <p className="text-sm text-muted-foreground max-w-xs leading-relaxed mb-8">
          Registre entradas de mercadoria e acompanhe o estoque em tempo real.
        ...
        <div className="w-full max-w-xs space-y-2 mb-8">
          {[
            { icon: PackagePlus,   label: 'Entrada de mercadoria' },
            { icon: PackageMinus,  label: 'Baixa manual de estoque' },
            { icon: AlertTriangle, label: 'Alertas de estoque mínimo' },
          ].map(({ icon: Icon, label }) => (
            <div
              key={label}
